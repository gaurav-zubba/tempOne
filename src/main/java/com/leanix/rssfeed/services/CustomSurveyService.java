...
public class CustomSurveyService {
    ...
    public CustomSurveyService(String apiToken) {
    ...
    public JSONObject getWorkspaceInfo(String accessToken){
        ...
        System.out.println("Fetching workspace info : ");
        ...
        System.out.println("workspace info : " + decoded);
    ...
    public JSONObject getSurveyToken(String accessToken, String userId) throws IOException {
        ...
        System.out.println("Creating token for survey  ");
    ...
    public String updateFactSheetQuery(JSONObject data, String accessToken) throws IOException {
        ...
        System.out.println("Updating Fact Sheet and user Query to the survey poll ");
    ...
    public String startPoll(JSONObject poll, String accessToken, String workspaceId) throws IOException {
        ...
        System.out.println("Starting the poll live : ");
    ...
    public String getPollResult(String pollId , String accessToken) throws IOException {
